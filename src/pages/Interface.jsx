...
export default function Interface() {
  ...
  const changeAccessCamera = () => {
    setCameraAccepted((prev) => !prev);
  };
          ...
          (cameraAccepted ? (
            <Canvas>
              <FaceLandmarker>
                ...
                {choiceCamera && !tutorial && cameraAccepted && (
                ...
                <Html center position={[0, 0, -25]}>
                  <div className="w-screen h-screen flex justify-center">
                    <div className="flex mt-32 sm:mt-96 flex-col justify-center items-center">
                      <p className="mb-4 sm:mb-14 text-base px-4 md:px-0 md:text-xl font-bold text-white text-center">
